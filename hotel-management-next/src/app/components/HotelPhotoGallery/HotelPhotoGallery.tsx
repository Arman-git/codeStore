    ...
    <div className="container mx-auto">
      <div className="grid md:grid-cols-2 relative gap-5 px-3">
        <div className="relative rounded-2xl overflow-hidden h-[540px]">
          ...
          <div className="md:hidden justify-center items-center w-full h-full flex">
            <Image
        ...
        <div className="md:hidden flex justify-between items-center">
          <div className="flex space-x-2">
            <FaArrowLeft className="cursir-pointer" onClick={handlePrevious} />
            <FaArrowRight className="cursir-pointer" onClick={handleNext} />
          </div>
          <span>
