/*
  ...
  - You are about to drop the column `firstNme` on the `Employee` table. All the data in the column will be lost.
...
INSERT INTO "new_Employee" ("id", "lastName", "userId") SELECT "id", "lastName", "userId" FROM "Employee";
DROP TABLE "Employee";
